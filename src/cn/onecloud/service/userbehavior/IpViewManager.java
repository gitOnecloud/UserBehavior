...
import cn.onecloud.dao.userbehavior.IpViewDao;
...
@Service("ipViewManager")
public class IpViewManager {

	private IpViewDao idao;
	@Resource(name="ipViewDao")
	public void setIdao(IpViewDao idao) {
		this.idao = idao;
	}
